...
<div class="page-header">
    <h1> Tambah Produk<small> <i class="ace-icon fa fa-angle-double-right"></i> tambah produk, beserta macam-macam ukuran dan harganya </small></h1>
</div>
{!! Form::model($product, ['route' => ['products.store', $product->id],'method' => 'post','enctype' => 'multipart/form-data']) !!}

<div class="row">

    <div class="col-md-5">
        <div class="panel panel-default">
            <div class="panel-heading"><h3 class="panel-title">Produk Baru</h3></div>
            <div class="panel-body">

                <div class="form-group">
                    <label for="thumbnail" class="form-label">Thumbnail</label><br>
                    {{-- <img src="{{asset('images/noimage.jpg')}}" style="height: 100px" > --}}
                    {!! Form::file('img') !!}
                ...
                'placeholder' => 'kosongkan jika tidak menyediakan',
